...
set_interface_property avalon_streaming_sink_1 dataBitsPerSymbol 32
...
add_interface_port avalon_streaming_sink_1 sink_data_fifo1 data Input 32
add_interface_port avalon_streaming_sink_1 sink_valid_fifo1 valid Input 1
add_interface_port avalon_streaming_sink_1 sink_ready_fifo1 ready Output 1
add_interface_port avalon_streaming_sink_1 sink_sop_fifo1 startofpacket Input 1
add_interface_port avalon_streaming_sink_1 sink_eop_fifo1 endofpacket Input 1
...
add_interface_port avalon_streaming_source_1 source_data_fifo1 data Output 32
add_interface_port avalon_streaming_source_1 source_ready_fifo1 ready Input 1
add_interface_port avalon_streaming_source_1 source_valid_fifo1 valid Output 1
add_interface_port avalon_streaming_source_1 source_eop_fifo1 endofpacket Output 1
add_interface_port avalon_streaming_source_1 source_sop_fifo1 startofpacket Output 1
...
set_interface_property avalon_streaming_sink_2 dataBitsPerSymbol 32
...
add_interface_port avalon_streaming_sink_2 sink_data_fifo2 data Input 32
add_interface_port avalon_streaming_sink_2 sink_eop_fifo2 endofpacket Input 1
add_interface_port avalon_streaming_sink_2 sink_ready_fifo2 ready Output 1
add_interface_port avalon_streaming_sink_2 sink_sop_fifo2 startofpacket Input 1
add_interface_port avalon_streaming_sink_2 sink_valid_fifo2 valid Input 1
...
set_interface_property avalon_streaming_sink_3 dataBitsPerSymbol 32
...
set_interface_property avalon_streaming_sink_3 EXPORT_OF ""
set_interface_property avalon_streaming_sink_3 PORT_NAME_MAP ""
set_interface_property avalon_streaming_sink_3 CMSIS_SVD_VARIABLES ""
set_interface_property avalon_streaming_sink_3 SVD_ADDRESS_GROUP ""

add_interface_port avalon_streaming_sink_3 sink_data_fifo3 data Input 32
add_interface_port avalon_streaming_sink_3 sink_eop_fifo3 endofpacket Input 1
add_interface_port avalon_streaming_sink_3 sink_ready_fifo3 ready Output 1
add_interface_port avalon_streaming_sink_3 sink_sop_fifo3 startofpacket Input 1
add_interface_port avalon_streaming_sink_3 sink_valid_fifo3 valid Input 1


# 
# connection point avalon_streaming_sink_4
# 
add_interface avalon_streaming_sink_4 avalon_streaming end
set_interface_property avalon_streaming_sink_4 associatedClock clock
set_interface_property avalon_streaming_sink_4 associatedReset reset
set_interface_property avalon_streaming_sink_4 dataBitsPerSymbol 32
set_interface_property avalon_streaming_sink_4 errorDescriptor ""
set_interface_property avalon_streaming_sink_4 firstSymbolInHighOrderBits true
set_interface_property avalon_streaming_sink_4 maxChannel 0
set_interface_property avalon_streaming_sink_4 readyLatency 0
set_interface_property avalon_streaming_sink_4 ENABLED true
set_interface_property avalon_streaming_sink_4 EXPORT_OF ""
set_interface_property avalon_streaming_sink_4 PORT_NAME_MAP ""
set_interface_property avalon_streaming_sink_4 CMSIS_SVD_VARIABLES ""
set_interface_property avalon_streaming_sink_4 SVD_ADDRESS_GROUP ""

add_interface_port avalon_streaming_sink_4 sink_data_fifo4 data Input 32
add_interface_port avalon_streaming_sink_4 sink_eop_fifo4 endofpacket Input 1
add_interface_port avalon_streaming_sink_4 sink_ready_fifo4 ready Output 1
add_interface_port avalon_streaming_sink_4 sink_sop_fifo4 startofpacket Input 1
add_interface_port avalon_streaming_sink_4 sink_valid_fifo4 valid Input 1
...
set_interface_property avalon_streaming_source_2 dataBitsPerSymbol 32
...
add_interface_port avalon_streaming_source_2 source_data_fifo2 data Output 32
add_interface_port avalon_streaming_source_2 source_eop_fifo2 endofpacket Output 1
add_interface_port avalon_streaming_source_2 source_ready_fifo2 ready Input 1
add_interface_port avalon_streaming_source_2 source_sop_fifo2 startofpacket Output 1
add_interface_port avalon_streaming_source_2 source_valid_fifo2 valid Output 1
...
set_interface_property avalon_streaming_source_3 dataBitsPerSymbol 32
...
add_interface_port avalon_streaming_source_3 source_data_fifo3 data Output 32
add_interface_port avalon_streaming_source_3 source_eop_fifo3 endofpacket Output 1
add_interface_port avalon_streaming_source_3 source_ready_fifo3 ready Input 1
add_interface_port avalon_streaming_source_3 source_sop_fifo3 startofpacket Output 1
add_interface_port avalon_streaming_source_3 source_valid_fifo3 valid Output 1


# 
# connection point avalon_streaming_source_4
# 
add_interface avalon_streaming_source_4 avalon_streaming start
set_interface_property avalon_streaming_source_4 associatedClock clock
set_interface_property avalon_streaming_source_4 associatedReset reset
set_interface_property avalon_streaming_source_4 dataBitsPerSymbol 32
set_interface_property avalon_streaming_source_4 errorDescriptor ""
set_interface_property avalon_streaming_source_4 firstSymbolInHighOrderBits true
set_interface_property avalon_streaming_source_4 maxChannel 0
set_interface_property avalon_streaming_source_4 readyLatency 0
set_interface_property avalon_streaming_source_4 ENABLED true
set_interface_property avalon_streaming_source_4 EXPORT_OF ""
set_interface_property avalon_streaming_source_4 PORT_NAME_MAP ""
set_interface_property avalon_streaming_source_4 CMSIS_SVD_VARIABLES ""
set_interface_property avalon_streaming_source_4 SVD_ADDRESS_GROUP ""

add_interface_port avalon_streaming_source_4 source_data_fifo4 data Output 32
add_interface_port avalon_streaming_source_4 source_eop_fifo4 endofpacket Output 1
add_interface_port avalon_streaming_source_4 source_ready_fifo4 ready Input 1
add_interface_port avalon_streaming_source_4 source_sop_fifo4 startofpacket Output 1
add_interface_port avalon_streaming_source_4 source_valid_fifo4 valid Output 1
...
set_interface_property conduit_spi associatedClock clock
set_interface_property conduit_spi associatedReset ""
set_interface_property conduit_spi ENABLED true
set_interface_property conduit_spi EXPORT_OF ""
set_interface_property conduit_spi PORT_NAME_MAP ""
set_interface_property conduit_spi CMSIS_SVD_VARIABLES ""
set_interface_property conduit_spi SVD_ADDRESS_GROUP ""

add_interface_port conduit_spi SPI_Clk spi_clk Input 1
add_interface_port conduit_spi SPI_MISO spi_miso Output 1
add_interface_port conduit_spi SPI_MOSI spi_mosi Input 1
add_interface_port conduit_spi SPI_CS_n spi_cs_n Input 1
